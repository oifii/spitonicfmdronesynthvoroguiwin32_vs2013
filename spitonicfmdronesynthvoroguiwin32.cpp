...
#include "stdafx.h"
#include "spitonicfmdronesynthvoroguiwin32.h"
#include "FreeImage.h"
...
TCHAR szTitle[1024]={L"spitonicfmdronesynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicfmdronesynthvoroguiwin32class"};				// the main window class name
